...
export class TommyHilfigerParser implements IProductParser {
  parse(html: string, name: string, size: string): IProduct {
    ...
    const product = new Product(title, price, name, inStock)
